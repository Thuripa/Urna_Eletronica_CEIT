...
class Ui_tela_confirmacao(object):
    ...
    def preenche_tela(self, num_voto):
        # Preenche a tela de acordo com a chapa escolhida
    ...
    def setupUi(self, Dialog, posicaoTabela2=680):
        ...
        self.lbl_1_sec.setGeometry(QtCore.QRect(posicaoTabela2, 260, larguraLabel, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.lbl_1_tes.setGeometry(QtCore.QRect(posicaoTabela2, 320, larguraLabel, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.lbl_dir_cultura.setGeometry(QtCore.QRect(posicaoTabela2, 370, larguraLabel, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.lbl_vice_pres.setGeometry(QtCore.QRect(posicaoTabela2, 210, larguraLabel, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_vice_pres.setFont(font)
        self.lbl_vice_pres.setObjectName("lbl_vice_pres")
        self.lbl_dir_social = QtWidgets.QLabel(Dialog)
        self.lbl_dir_social.setGeometry(QtCore.QRect(posicaoTabela2, 430, larguraLabel, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.lbl_2_suplente.setGeometry(QtCore.QRect(posicaoTabela2, 480, larguraLabel, 24))
        font = QtGui.QFont()
        font.setPointSize(12)
